...
trinomial_x_labels(trinomial_x_labels == 0) = 'X'; trinomial_x_labels(trinomial_x_labels == 1) = 'Y'; trinomial_x_labels(trinomial_x_labels == 2) = 'Z';
...
for i = 1:41
    ...
    aux = [repmat(str_normal,4,1) trinomial_x_labels{i}(1:4,:)];
    
    aux(5,1:length(str_bold)) = str_bold; aux(5,end+1) = trinomial_x_labels{i}(5);
    
    trinomial_x_labels{i} = aux;
   
end

trinomial_x_labels_latex = trinomial_x_labels;

save('trinomial_x_labels_latex_sans','trinomial_x_labels_latex');