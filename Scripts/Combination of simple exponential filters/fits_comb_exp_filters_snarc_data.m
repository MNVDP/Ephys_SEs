...
%%
        ...
        create_seq_eff_plot(data,rt_prediction,'font','times','labeltype','ci','errors',std_error_ci);

        ylabel('SNARC slope','fontsize',15,'fontweight','bold'); 
...
% %        printpdf(gcf,'fit_slrp_lrpr_4back_jentzsch.pdf');
         printpdf(gcf,'fit_exp_filt_snarc_data_resp_alt.pdf');
%     
%         cd ..
%         
         close all
