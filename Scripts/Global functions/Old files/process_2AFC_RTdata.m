...
function [data] = process_2AFC_RTdata(list_of_subjects,list_of_dates,n_trials,n_blocks,directory)
...
for i = 1:n_subjects
    ...
    load(strcat(directory,'/',list_of_subjects{i},'/',list_of_subjects{i},list_of_dates{i}),'reactionTime','randomSequence','keyPressed');
