...
function [data] = process_2AFC_RTdata_one_vs_many(list_of_subjects,list_of_dates,n_trials,n_blocks)
...
for i = 1:n_subjects
    ...
    %the target equals 1 and the rest equals 2
    randomSequence(randomSequence == mode(randomSequence)) = 1;  %#ok<SAGROW>
    randomSequence(randomSequence ~= mode(randomSequence)) = 2; %#ok<SAGROW>
